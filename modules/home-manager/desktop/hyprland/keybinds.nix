...

{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      # Apps
      "$mainMod, Return, exec, ~/.config/hypr/hyprland/scripts/launch_first_available.sh \"\${TERMINAL}\" \"kitty -1\" \"foot\" \"alacritty\" \"wezterm\" \"konsole\" \"kgx\" \"uxterm\" \"xterm\""
      "$mainMod, T, exec, ~/.config/hypr/hyprland/scripts/launch_first_available.sh  \"\${TERMINAL}\" \"kitty -1\" \"foot\" \"alacritty\" \"wezterm\" \"konsole\" \"kgx\" \"uxterm\" \"xterm\""
      ...
      "$mainMod, E, exec, ~/.config/hypr/hyprland/scripts/launch_first_available.sh \"dolphin\" \"nautilus\" \"nemo\" \"thunar\" \"\${TERMINAL}\" \"kitty -1 fish -c yazi\""
