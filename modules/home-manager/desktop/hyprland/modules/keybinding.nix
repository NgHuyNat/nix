  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      bind = [
        ...
        # "ALT, SPACE, exec, ${hostVars.nix_config}/scripts/fuzzel/fuzzel.sh" # [hidden] Launcher (fallback)
      ...
      bindel = [
        ", XF86AudioRaiseVolume, exec, ${hostVars.nix_config}/home/shared/hypr/scripts/volume.sh --inc"
        ", XF86AudioLowerVolume, exec, ${hostVars.nix_config}/home/shared/hypr/scripts/volume.sh --dec"
        ", XF86AudioMute, exec, ${hostVars.nix_config}/home/shared/hypr/scripts/volume.sh --toggle"
        ", XF86AudioMicMute, exec, wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"
        ", XF86MonBrightnessUp, exec, ${hostVars.nix_config}/home/shared/hypr/scripts/brightness.sh --inc"
        ", XF86MonBrightnessDown, exec, ${hostVars.nix_config}/home/shared/hypr/scripts/brightness.sh --dec"
      ];
    };
  };
}
