...

{
  ...
  systemd.user.services = {
    ...
    # Wayland idle inhibitor - DISABLED: wayland-idle-inhibitor.py script not present
    ...
    #   Service = {
    #     Type = "simple";
    #     ExecStart = "${config.home.homeDirectory}/.local/state/quickshell/.venv/bin/python ${config.home.homeDirectory}/Workspaces/Config/nixos/modules/home-manager/features/quickshell/config/ii/scripts/wayland-idle-inhibitor.py";
    #     Restart = "on-failure";
    #     RestartSec = 1;
